...
[https://spike150.mocanyc.org/spike-relay/club/club_detail.html](https://spike150.mocanyc.org/spike-relay/club/club_detail.html)


To see other club detail, add hashtag to the URL, such as

- [https://spike150.mocanyc.org/spike-relay/club/club_detail.html#241951](https://spike150.mocanyc.org/spike-relay/club/club_detail.html#241951)

- [https://spike150.mocanyc.org/spike-relay/club/club_detail.html#229749](https://spike150.mocanyc.org/spike-relay/club/club_detail.html#229749)

- [https://spike150.mocanyc.org/spike-relay/club/club_detail.html#155681](https://spike150.mocanyc.org/spike-relay/club/club_detail.html#155681)

- [https://spike150.mocanyc.org/spike-relay/club/club_detail.html#484248](https://spike150.mocanyc.org/spike-relay/club/club_detail.html#484248) (no ambassador image)

- [https://spike150.mocanyc.org/spike-relay/club/club_detail.html#438046](https://spike150.mocanyc.org/spike-relay/club/club_detail.html#438046) (no ambassador image)

- [https://spike150.mocanyc.org/spike-relay/club/club_detail.html#523430](https://spike150.mocanyc.org/spike-relay/club/club_detail.html#523430)
  ...
  main.variable(observer("clubs")).define("clubs", ["id","club","html"], function(id,club,html)
{
  ...
  if(id) {
    ...
    document.title += club.profile[id].en ? club.profile[id].en : ''
    document.title += club.profile[id].cn ? `| ${club.profile[id].cn}` : ''
    return html`
${club.detail_html(id)}
`
  }
  ...
  main.variable(observer("club")).define("club", ["profile","avatar","members","detail_html","logo_html","weeks"], function(profile,avatar,members,detail_html,logo_html,weeks)
{ 
  let club = {}
